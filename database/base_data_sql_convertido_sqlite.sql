-- Dados base para produtos_base e precos_base (SQLite)
-- Idempotente: DELETE antes de INSERT garante resultado consistente em execucoes repetidas

DELETE FROM precos_base;
DELETE FROM produtos_base;
